                                                ...
                                                <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                    <div className="modal-content">
                                                        ...
                                                        <div className="modal-body fw-normal">
                                                            {Array.from(new Set(data.map((item) => item[column.name]))).map((value, index) => (
                                                                <div className="form-check my-4" key={`${column.name}-${value}`}>
                                                                    <input
                                                                        ...
                                                                        value={value}
                                                                        checked={
                                                                            selectedFilters[column.name]?.includes(value) || false
                                                                        }
                            ...
                            {filteredData.map((item, index) => (
                                <tr key={index}>
                                    {columns.map((column, i) =>
                                        column.visible ? <td key={`${index}-${i}`}>{item[column.name]}</td> : null
                                    )}
                                </tr>
                            ))}
                        </tbody>
